...
\newcommand{\titel}{Entwicklung eines VHDL-basierten Applikationsbeispiels zur Ablösung des FM350-2 Moduls durch das TM FAST Modul}
...
\newcommand{\zweitgutachter}{Prof. Dr. Albrecht} %Prof.\,Dr.~Bartosz von\,Rymon\,Lipinski
\newcommand{\betreuerunternehmen}{Conrad, Maximilian} %M.Sc.\,~Martina Schmidt
\newcommand{\unternehmen}{Siemens AG}
...
\usepackage{float}
\usepackage{tabularx}
\usepackage{longtable} % Im Präambelbereich einfügen, falls noch nicht vorhanden
...
\usepackage{xr}
\externaldocument{content/2_Grundlagen} 
